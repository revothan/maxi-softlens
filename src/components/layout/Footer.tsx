        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Premium softlens for your eyes. Quality products from trusted brands.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-map-pin mr-2 mt-0.5">
                  <path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path>
                  <circle cx="12" cy="10" r="3"></circle>
                </svg>
                <span>
                  Ruko Golden Madrid 2 <br />
                  Blok E No. 10 BSD City <br />
                  Tangerang, Banten
                </span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span>info@maxisoftlens.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t mt-8 pt-6">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground mb-4 sm:mb-0">
              &copy; {currentYear} Maxi Softlens. All rights reserved.
            </p>
